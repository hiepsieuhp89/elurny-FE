...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-pointer select-none items-center rounded-[10px] py-1.5 pl-8 pr-2 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      "text-[#A7A7A7] font-normal text-base",
      "data-[state=checked]:bg-[#8657c5] data-[state=checked]:text-white data-[state=checked]:font-bold",
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <div className={cn(
        ...
        "data-[state=unchecked]:border-[#6C7278]"
      )}>
