        ...
        <main className="min-h-screen bg-mainBackgroundV1">
            ...
            <section className="container py-16 md:py-24">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        Turn any content into <span className="text-mainVioletV1">Lurnies</span>
                    </motion.h1>
                    ...
                    <motion.div variants={itemVariants} className="relative">
                        <div className="relative rounded-lg overflow-hidden border border-gray-800">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <motion.button
                                    className="w-16 h-16 rounded-full bg-mainVioletV1/90 flex items-center justify-center"
                        ...
                        <div className="absolute -bottom-3 -right-3 bg-mainVioletV1/20 text-mainVioletV1 text-sm px-3 py-1 rounded-full">
                            Learning in action
                        </div>
                    </motion.div>
                </motion.div>
                        ...
                        {benefits.map((benefit, index) => (
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-mainVioletV1/20 flex items-center justify-center text-xl font-bold text-mainVioletV1">
                                        {benefit.number}
                                    </div>
                                    <div>
                    ...
                    {subFeatures.map((feature, index) => (
                        ...
                        >
                            <div className="mb-4 flex items-center gap-2">
                                {feature.icon}
                                <h3 className="text-mainVioletV1 text-sm font-bold uppercase tracking-wider">{feature.title}</h3>
                            </div>
